...
# Bu ifade kullanılarak kameradan alınan karede yüzler tespit edilir ve bu 
#yüzlerin koordinatları face_rects değişkenine atanır.
...
if len(face_rects) > 0:
    ...
    # region of interest -> ilgilenilen bölge yani yüz
    ...
    while True:
        ...
        if ret:
            ...
            # piksel karşılaştırma görüntümüzün her karede histogram karşılaştırmasına bakıyor
